    ...
    return (
        <>
            ...
            <div className={"articleCatCircle"}>
                <h2 className={"secondCatArticle"}>Полезные статьи и последние новости</h2>
                <h3 className={"catArticleText"}>Читайте истории наших подопечных, советы по уходу за котиками и новости из жизни приюта.</h3>
            ...
            <div className={"aboutShelter"}>
                ...
                <div className={"textAboutShelter"}>
                    ...
                    <p><b>Мы - самый крупный кошачий приют за Уралом</b><br/>Cоздаём комфортные условия для жизни кошек и&nbsp;стремимся помочь им найти любящих хозяев. Каждый питомец получает полноценное питание, медицинский уход и заботу. Усыновление происходит по&nbsp;договору, с последующей поддержкой и
                        обратной связью</p>
                </div>
            ...
            <div className={"howTTHome"}>
                ...
                <div className={"text1"}>ознакомьтесь<br/><p>с анкетами кошек на сайте</p></div>
                <div className={"text2"}>выберете<br/><p>будущего любимца</p></div>
                ...
                <div className={"donateBlock"}>
                    ...
                    <form action="" method="post" className={"donateForm"}>
                        ...
                        <div className={"form-example checkBox"}>
                            <input type="radio" id="radio-1" value="month" name={"radio"} checked={true}/>
                            <label htmlFor={"radio-1"} className={"button"}>Ежемесячно</label>
                            <input type="radio" id="radio-2" value="once" name={"radio"}/>
                            <label htmlFor={"radio-2"} className={"button"}>Единоразово</label>
                        </div>
                        <div className={"form-example"}>
                        ...
                        <div className={"form-example"}>
                            <label htmlFor={"userAgree"} className={"userAgree"}><input type="checkbox" name={"userAgree"}/>Я принимаю <a
                                href="">Условия сервиса</a></label>
